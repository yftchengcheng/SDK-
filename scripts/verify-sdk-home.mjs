...
await page.goto('http://localhost:5000/sdk/index', { waitUntil: 'domcontentloaded' });
await wait(2500);
...
console.log('html contains YTads?', html.includes('YTads'));
await page.screenshot({ path: '/workspace/projects/public/sdk-screenshots/sdk-home-v2.png', clip: { x: 0, y: 0, width: 1440, height: 700 } });
await browser.close();
