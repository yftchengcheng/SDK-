...
const info = await page.evaluate(() => {
  ...
  return {
    split: r(document.querySelector('.funnel-split')),
    splitLeft: r(document.querySelector('.funnel-split-left')),
    splitRight: r(document.querySelector('.funnel-split-right')),
    toolbar: r(document.querySelector('.funnel-split-toolbar')),
    layout: r(document.querySelector('.funnel-layout')),
    wrap: r(document.querySelector('.funnel-chart-wrap')),
