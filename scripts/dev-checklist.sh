...
echo ""
echo "█████████████████████████████████████████████████████████████"
echo "█  ❌  $FAIL 项未通过 — 严格禁止说'OK / 修好 / 完成'         █"
echo "█████████████████████████████████████████████████████████████"
echo ""
echo "  1. ❌ 禁止说'全部 OK'/'代码修好了'/'可以交付'"
echo "  2. ❌ 禁止忽略下面 FAILED 项"
echo "  3. ✅ 必须把下面 ❌ 项原样复制给用户"
echo "  4. ✅ 必须把 ❌ 项列为'下一步必做'"
echo ""
echo "  FAILED 项 (必须原样告知用户):"
echo ""
exit 1
