...
.policy-notice__list li {
  color: #1e3a8a;
  margin-bottom: 2px;
}
.policy-notice__list li strong {
  color: #1e40af;
  font-weight: 600;
}
.policy-notice__list a {
  color: #2563eb;
...
.policy-app-card__info {
  flex: 1;
  min-width: 0;
}
.policy-app-card__name {
  font-size: 14px;
  color: #1e293b;
  font-weight: 500;
  white-space: nowrap;
...
.policy-app-card__copy {
  cursor: pointer;
  color: #94a3b8;
  transition: color 0.15s;
}
.policy-app-card__copy:hover {
  color: #3b82f6;
}
...
.policy-dual__item:hover {
  border-color: #3b82f6;
  background: #f0f7ff;
}
.policy-dual__item--selected {
  border-color: #10b981;
  background: #f0fdf4;
}
.policy-dual__item--selected:hover {
  border-color: #ef4444;
  background: #fef2f2;
}
.policy-dual__item-main {
  flex: 1;
  min-width: 0;
}
.policy-dual__item-name {
  font-size: 13px;
  color: #1e293b;
  font-weight: 500;
  white-space: nowrap;
...
.policy-dual__item-arrow {
  color: #94a3b8;
  font-size: 14px;
  flex-shrink: 0;
  margin-left: 6px;
}
.policy-dual__item:hover .policy-dual__item-arrow {
  color: #3b82f6;
}
.policy-dual__item--selected:hover .policy-dual__item-arrow {
  color: #ef4444;
}
</style>
