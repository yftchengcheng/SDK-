...
export const CHINA_REGIONS: ChinaRegion[] = [
  ...
  { code: '120000', name: '天津', cities: [
    { code: '120100', name: '天津市' }
  ]},
  { code: '130000', name: '河北', cities: [
  ...
  { code: '310000', name: '上海', cities: [
    { code: '310100', name: '上海市' }
  ]},
  { code: '320000', name: '江苏', cities: [
  ...
  { code: '410000', name: '河南', cities: [
    ...
    { code: '411700', name: '驻马店市' }, { code: '419000', name: '省直辖县级行政区划' }
  ]},
  { code: '420000', name: '湖北', cities: [
  ...
  { code: '640000', name: '宁夏', cities: [
    { code: '640100', name: '银川市' }, { code: '640200', name: '石嘴山市' },
    { code: '640300', name: '吴忠市' }, { code: '640400', name: '固原市' },
    { code: '640500', name: '中卫市' }
  ]},
  { code: '650000', name: '新疆', cities: [
    { code: '650100', name: '乌鲁木齐市' }, { code: '650200', name: '克拉玛依市' },
    { code: '650400', name: '吐鲁番市' }, { code: '650500', name: '哈密市' },
    { code: '652100', name: '昌吉回族自治州' }, { code: '652200', name: '博尔塔拉蒙古自治州' },
    { code: '652300', name: '巴音郭楞蒙古自治州' }, { code: '652700', name: '克孜勒苏柯尔克孜自治州' },
    { code: '652800', name: '和田地区' }, { code: '652900', name: '伊犁哈萨克自治州' },
    { code: '653000', name: '塔城地区' }, { code: '653100', name: '阿勒泰地区' },
    { code: '654000', name: '自治区直辖县级行政区划' }
  ]},
  { code: '710000', name: '台湾', cities: [
    { code: '710100', name: '台北市' }, { code: '710200', name: '高雄市' },
    { code: '710300', name: '台南市' }, { code: '710400', name: '台中市' },
    { code: '710500', name: '新北市' }, { code: '710600', name: '桃园市' },
    { code: '710700', name: '基隆市' }, { code: '710800', name: '新竹市' },
    { code: '710900', name: '嘉义市' }
  ]},
  { code: '810000', name: '香港', cities: [
    { code: '810100', name: '香港特别行政区' }
  ]},
  { code: '820000', name: '澳门', cities: [
