...
import reportAggregateRoutes from './report-aggregate';
...
router.use('/api/v1/console/report-metric', reportMetricRoutes);
router.use('/api/v1/console/report/board', reportBoardRoutes);
router.use('/api/v1/console/report', reportAggregateRoutes);
